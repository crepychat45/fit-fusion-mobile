...
const Profile = () => {
  ...
  const handleProfileSave = () => {
    ...
    toast({
      ...
      description: "Your profile has been successfully updated and synced to cloud.",
    });
  };
  ...
  const toggleSubscription = () => {
    ...
    toast({
      ...
      description: newStatus ? "You now have access to premium features!" : "Your premium access has been deactivated.",
    });
  };
  ...
  const toggleBiometricAuth = () => {
    ...
    toast({
      ...
      description: biometricAuth ? "Fingerprint/Face ID login has been disabled." : "You can now log in using your fingerprint or face ID.",
    });
  };
  ...
  const toggleTwoFactorAuth = () => {
    ...
    toast({
      ...
      description: twoFactorAuth ? "2FA has been disabled for your account." : "Your account is now more secure with 2FA.",
    });
  };
                  ...
                  <CardContent className="space-y-4">
                    <ScrollArea className="h-[300px] pr-4">
                      ...
                      >
                        ...
                        <p className="text-sm text-muted-foreground mb-3">
                          You've set a new personal best for bench press: 185 lbs!
                        </p>
                        <div className="flex items-center gap-2">
                      ...
                      >
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center gap-2">
                            ...
                            <h4 className="font-medium">New AI Recommendation</h4>
                          </div>
                          <span className="text-xs text-muted-foreground">5 days ago</span>
                        </div>
                        <p className="text-sm text-muted-foreground mb-3">
                          Based on your progress, our AI suggests focusing more on upper body strength this week.
                        </p>
                  ...
                  <CardContent className="space-y-6">
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <Label htmlFor="biometric" className="text-base font-medium">Biometric Authentication</Label>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <Label htmlFor="dataSync" className="text-base font-medium">Data Synchronization</Label>
                          <p className="text-sm text-muted-foreground mt-1">
                    ...
                    <Card className="mt-6 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-950/20 dark:to-orange-950/20 border-amber-200">
                      <CardHeader>
                        <CardTitle className="flex items-center gap-2">
                          ...
                          {isSubscriptionActive ? "Your Premium Subscription" : "Upgrade to FitFusion Pro"}
                        </CardTitle>
                        <CardDescription>
                          {isSubscriptionActive 
                      ...
                      <CardContent>
                        ...
                        <Button 
                          ...
                          className={`w-full ${isSubscriptionActive 
