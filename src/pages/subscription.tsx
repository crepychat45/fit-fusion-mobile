...
const SubscriptionPage = () => {
  ...
  const [paymentMethod, setPaymentMethod] = useState<"CreditCard" | "DebitCard" | "NetBanking" | "GPay" | "PhonePe" | "UPI" | "Cash">("CreditCard");
    ...
    setTimeout(() => {
      ...
      if (savedProfile) {
        try {
          const parsed = JSON.parse(savedProfile);
          parsed.isPro = true;
          parsed.subscriptionTier = selectedPlan === "basic" ? "Basic" : selectedPlan === "pro" ? "Pro" : "Elite";
      ...
      setCurrentPlan(selectedPlan === "basic" ? "Basic" : selectedPlan === "pro" ? "Pro" : "Elite");
  ...
  const faqs = [
    {
      ...
      answer: "You can cancel your subscription at any time from your account settings. Your benefits will continue until the end of your current billing cycle."
    },
    {
      question: "Will I get charged after the trial period?",
      answer: "Yes, if you don't cancel before the trial ends, you'll be charged for the plan you selected during sign-up."
    },
    {
      question: "Can I switch between plans?",
      answer: "Absolutely! You can upgrade or downgrade your plan at any time. If you upgrade, the change happens immediately. If you downgrade, the change will be applied at the end of your current billing cycle."
    },
    {
      question: "Are there any hidden fees?",
      answer: "No, the price you see is the price you pay. No hidden fees, no surprise charges."
    },
    {
        ...
        >
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-white/80 mt-2">
              Upgrade your fitness journey with premium features and personalized training
            </p>
          </div>
        </motion.div>
      </div>
      ...
      <div className="px-4 py-6 max-w-4xl mx-auto">
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="grid w-full grid-cols-3">
            ...
            <TabsTrigger value="checkout" disabled={!selectedPlan || isSubscribed}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {plans.map((plan) => (
                    ...
                    >
                      ...
                      <Card className={`overflow-hidden ${plan.recommended ? 'border-primary shadow-lg' : ''}`}>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="flex flex-col items-center text-center p-4">
                      ...
                      <h3 className="font-medium mb-1">Premium Workout Videos</h3>
                      <p className="text-sm text-muted-foreground">
                        Access our library of high-quality workout videos with professional trainers
                      </p>
                    </div>
                  ...
                  <div className="space-y-6">
                    ...
                    {paymentMethod === "NetBanking" && (
                      <Card>
                        <CardContent className="pt-6">
                          <p className="text-center mb-4">Select your bank to proceed with Net Banking</p>
                    ...
                    {(paymentMethod === "GPay" || paymentMethod === "PhonePe" || paymentMethod === "UPI") && (
                      <Card>
                        <CardContent className="pt-6">
                          <div className="text-center">
                            <p className="mb-4">Enter your UPI ID to proceed with payment</p>
                            <Input 
                              placeholder={paymentMethod === "GPay" ? "name@okaxis" : "name@upi"} 
                    ...
                    <div className="text-sm text-muted-foreground">
                      <p className="mb-2">By completing this purchase you agree to our:</p>
                  ...
                  <CardContent className="space-y-6">
                    <div className="flex items-center justify-between">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-medium text-lg">{currentPlan} Plan</h3>
                          <p className="text-sm text-muted-foreground">
                    ...
                    <div className="bg-muted/50 rounded-lg p-4">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <p className="text-sm">Next billing date: {expiryDate}</p>
                      </div>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <p className="text-muted-foreground">
                      Upgrade to FitFusion Premium to access exclusive features and personalized training.
                    </p>
                    <Button onClick={() => setActiveTab("plans")}>
