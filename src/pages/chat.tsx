  ...
  return (
    <div className="min-h-screen bg-background flex flex-col relative overflow-hidden">
      ...
      <motion.div
        ...
        className="relative pt-8 pb-4 px-4 shrink-0 shadow-xl overflow-hidden"
      >
          ...
          <div className="max-w-md mx-auto p-6 flex-1 flex items-center justify-center">
            ...
            >
              ...
              <motion.div
                ...
                className="mt-8"
              >
                <div className="bg-card/60 backdrop-blur-xl p-6 rounded-2xl border border-border/20 shadow-lg">
