...
const Help = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Yes, many features of FitFusion work offline. Your workout data will sync when you reconnect to the internet."
    },
    {
      question: "How do I earn achievements?",
      answer: "Achievements are earned by completing specific fitness goals, like workout streaks or trying different exercise types. View your achievements in your Profile."
    }
  ];
          ...
          <TabsContent value="faq">
            ...
            <div className="mt-6 p-4 bg-primary/10 rounded-lg border border-primary/20">
              ...
              <p className="text-sm text-muted-foreground mb-3">
                Can't find what you're looking for? Contact our support team or try our AI assistant.
              </p>
