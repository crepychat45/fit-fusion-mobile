...
import { ChevronLeft, Watch, Smartphone, HeartPulse, Bluetooth, Battery, BarChart2, RefreshCw, Plus, ChevronRight, Settings } from "lucide-react";
    ...
    <div className="min-h-screen bg-background pb-16">
      ...
      <div className="fitness-gradient pt-12 pb-6 px-4">
        <div className="flex items-center">
          ...
          <h1 className="text-xl font-bold text-white ml-2">Wearable Devices</h1>
        </div>
      </div>
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          <div className="bg-primary/10 p-3 rounded-full mr-3 flex items-center justify-center">
                            {device.type === "smartwatch" && <Watch className="h-5 w-5 text-primary" />}
                            {device.type === "fitness-band" && <HeartPulse className="h-5 w-5 text-primary" />}
                            {device.type === "smartphone" && <Smartphone className="h-5 w-5 text-primary" />}
                          </div>
                          <div>
                            <div className="flex items-center">
                      ...
                      <div className="grid grid-cols-4 gap-2 mt-4">
                        <div className="text-center p-2 bg-muted/50 rounded-md">
                          ...
                          <p className="font-medium">{device.stats.steps.toLocaleString()}</p>
                        </div>
                        <div className="text-center p-2 bg-muted/50 rounded-md">
                        ...
                        <div className="text-center p-2 bg-muted/50 rounded-md">
                          ...
                          <p className="font-medium">{device.stats.heartRate} bpm</p>
                        </div>
                        <div className="text-center p-2 bg-muted/50 rounded-md">
                          <p className="text-xs text-muted-foreground">Distance</p>
                          <p className="font-medium">{device.stats.distance} km</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
              ...
              <div className="py-4">
                <div className="flex items-center mb-4">
                  <div className="bg-primary/10 p-3 rounded-full mr-3">
                    {selectedDevice.type === "smartwatch" && <Watch className="h-5 w-5 text-primary" />}
                    {selectedDevice.type === "fitness-band" && <HeartPulse className="h-5 w-5 text-primary" />}
                    {selectedDevice.type === "smartphone" && <Smartphone className="h-5 w-5 text-primary" />}
                  </div>
                  <div>
                    <div className="flex items-center">
                      <Badge 
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-muted/50 p-3 rounded-md">
                        ...
                        <p className="text-xl font-medium mt-1">{selectedDevice.stats.steps.toLocaleString()}</p>
                      </div>
                      ...
                      <div className="bg-muted/50 p-3 rounded-md">
                        ...
                        <p className="text-xl font-medium mt-1">{selectedDevice.stats.heartRate} bpm</p>
                      </div>
                      ...
                      <div className="bg-muted/50 p-3 rounded-md">
                        ...
                        <p className="text-xl font-medium mt-1">{selectedDevice.stats.calories}</p>
                      </div>
                      ...
                      <div className="bg-muted/50 p-3 rounded-md">
                        ...
                        <p className="text-xl font-medium mt-1">{selectedDevice.stats.distance} km</p>
                      </div>
                    </div>
                  </div>
