...
export function ProfileEditor({ onSave }: ProfileEditorProps) {
  ...
  useEffect(() => {
    ...
    if (savedProfile) {
      try {
        ...
        setProfileImage(typeof profileData.profileImage === "string" && !profileData.profileImage.startsWith("data:") ? profileData.profileImage : null);
        setLastSaved(
  ...
  const autoSave = useCallback(async () => {
    ...
    const profileData = {
      ...
      height,
      weight,
      profileImage: profileImage?.startsWith("data:") ? null : profileImage,
