...
const responses: Record<string, string> = {
  ...
  "premium": "Upgrade to FitFusion Premium for advanced AI features, enhanced security, priority support, and exclusive AI models. Secure payment options available with multiple plans: Basic (₹500), Super (₹1000), and Advance (₹1700).",
  ...
  "security": "FitFusion uses military-grade security with AI threat detection, quantum encryption, biometric authentication, and real-time behavior analysis to protect your data.",
  "payment": "FitFusion offers secure payment gateways with multiple options including cards, crypto, and bank transfers. All payments are protected by PCI DSS compliance and fraud protection.",
  "ai features": "FitFusion now includes advanced AI features: AI Chat Assistant with multiple models (GPT-4, Claude, FitFusion-AI), AI Security System with threat detection, and AI-powered personalized recommendations.",
  "ai models": "Choose from multiple AI models: FitFusion-AI (personalized fitness AI), GPT-4 (advanced reasoning), and Claude (contextual understanding). Each model offers unique capabilities.",
  "voice": "FitFusion now supports voice messages! Record and send voice notes to communicate naturally with the AI assistant.",
  "media": "Share photos, videos, documents, and audio files with the AI assistant for personalized analysis and recommendations.",
  "threats": "Our AI Security System continuously monitors for threats, blocking malicious inputs, unauthorized access attempts, and data exfiltration in real-time.",
  "encryption": "All communications are protected with AES-256 encryption, quantum-resistant algorithms, and end-to-end encryption for maximum security.",
  "default": "I'm your enhanced AI assistant with advanced capabilities. Ask me about AI features, security, payments, or any fitness-related topics!"
};
...
export function AIChatbot() {
  ...
  const generateSuggestions = (userInput: string) => {
    if (!userInput.trim()) {
      return ["ai features", "security", "payment", "workout", "diet", "progress", "premium"];
    }
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-xs opacity-90">v4.0 • Enhanced with AI & Security</p>
              </div>
            </div>
            <div className="flex items-center gap-1">
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p>{encryptionEnabled ? "Encryption active" : "Encryption inactive"}</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
                      ...
                      >
                        <div className="flex items-center justify-between mb-1">
                          <div className="flex items-center gap-1">
                            ...
                            <span className="text-xs">{msg.isBot ? 'AI Assistant' : 'You'}</span>
