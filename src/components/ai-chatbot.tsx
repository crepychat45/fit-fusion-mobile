...
const responses: Record<string, string> = {
  ...
  "premium": "Upgrade to FitFusion Premium for advanced AI features, enhanced security, priority support, and exclusive AI models. Secure payment options available.",
