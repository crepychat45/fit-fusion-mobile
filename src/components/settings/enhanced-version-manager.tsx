...
const mockChangelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    changes: {
      features: [
        "🎨 New Glass Design Animated Logo with modern aesthetics",
        "🔒 Security Patch Download System with detailed changelogs and one-click installation",
        ...
        "🔐 Enhanced Mobile Security Center with advanced protection",
