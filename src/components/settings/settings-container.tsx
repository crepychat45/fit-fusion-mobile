  ...
  const validateAllSettings = async () => {
    ...
    for (let i = 0; i < validationSteps.length; i++) {
      ...
      toast({
        ...
        description: `Progress: ${Math.round((i + 1) / validationSteps.length * 100)}%`,
      });
    }
    ...
    return (
      ...
      >
        ...
        <p className="text-muted-foreground">
          Your session has ended securely. Please close this window or refresh the page to log in again.
        </p>
        <Button 
