...
export function EnhancedChatSettings({ onClose }: EnhancedChatSettingsProps) {
        ...
        setBackupProgress((prev) => {
          if (prev >= 100) {
            ...
            toast({
              ...
              description:
                "Your conversations have been safely backed up to FitFusion AI Cloud.",
            });
            return 100;
          }
          return prev + 10;
    ...
    try {
      const chatData = {
        ...
        conversations: JSON.parse(
          localStorage.getItem("fitfusion_chat_conversations") || "[]",
        ),
  ...
  return (
    <div
      className="space-y-6 max-h-[75vh] overflow-y-auto pr-3 custom-scrollbar"
      style={{
        scrollbarWidth: "thin",
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                saveSettings({ ...settings, encryptBackups: checked })
              }
            />
          </div>
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <Badge
                variant={backupStatus.lastBackup ? "default" : "secondary"}
              >
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <span className="ml-2 font-medium">
                  {backupStatus.cloudStorageUsed}
                </span>
              </div>
              <div>
                <span className="text-muted-foreground">Limit:</span>
                <span className="ml-2 font-medium">
                  {backupStatus.cloudStorageLimit}
                </span>
              </div>
            </div>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                saveSettings({ ...settings, vibrationNotifications: checked })
              }
            />
          </div>
        </CardContent>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                saveSettings({ ...settings, showTypingIndicator: checked })
              }
            />
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                saveSettings({ ...settings, autoDownloadMedia: checked })
              }
            />
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                saveSettings({ ...settings, saveToGallery: checked })
              }
            />
          </div>
        </CardContent>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                saveSettings({ ...settings, compressMedia: checked })
              }
            />
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                saveSettings({ ...settings, highQualityUploads: checked })
              }
            />
          </div>
