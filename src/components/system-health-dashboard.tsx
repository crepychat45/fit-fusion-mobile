  ...
  const [healthMetrics, setHealthMetrics] = useState<HealthMetric[]>([
    {
      ...
      status: 'excellent',
      issues: [],
      improvements: ['Image optimization implemented', 'Service worker caching active']
    },
    {
      name: 'Security',
      score: 98,
      status: 'excellent',
      issues: [],
      improvements: ['CSP headers configured', 'XSS protection enabled', 'HTTPS enforced']
    },
    {
      name: 'Accessibility',
      score: 90,
    ...
    },
    {
      ...
      status: 'excellent',
      issues: [],
      improvements: ['Responsive design optimized', 'Touch interactions enhanced']
    },
    {
      ...
      status: 'excellent',
      issues: [],
      improvements: ['Navigation simplified', 'Loading states improved', 'Error handling enhanced']
    }
  ]);
              ...
              <Card key={index}>
                <CardContent className="p-4">
                  ...
                  {metric.improvements.length > 0 && (
                    <div>
                      <div className="text-sm font-medium text-green-600 mb-1">Recent Improvements:</div>
