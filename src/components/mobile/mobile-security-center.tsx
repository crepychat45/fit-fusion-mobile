...
export function MobileSecurityCenter({ isOpen, onClose }: MobileSecurityCenterProps) {
  ...
  const handleSecurityScan = async () => {
    ...
    const newScore = Math.random() > 0.8 ? 
                ...
                <div className="flex items-center justify-between">
                  <span className="text-xs text-muted-foreground">
                    {securityScore >= 90 ? "Excellent Security" : 
                     securityScore >= 70 ? "Good Security" : "Needs Improvement"}
                  </span>
                  <Button 
                    variant="outline" 
                    size="sm" 
                  ...
                  <CardContent className="p-4 space-y-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <span className="font-medium text-sm">Biometric Lock</span>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="font-medium text-sm">Auto-Lock Timer</span>
                        </div>
