...
const mockWatchDevices: SmartWatchData[] = [
  {
    ...
    status: 'connected',
    features: ["GPS", "ECG", "Blood Oxygen", "Sleep Tracking", "Workout Detection"],
    isRecording: true
  },
  {
    id: "samsung-watch-1",
    ...
    lastSync: "1 hour ago",
    status: 'disconnected',
    features: ["GPS", "Heart Rate", "Sleep Tracking", "SpO2", "Body Composition"],
    isRecording: false
  },
  {
    id: "garmin-watch-1",
    ...
    lastSync: "Just now",
    status: 'connected',
    features: ["GPS", "Training Load", "VO2 Max", "Recovery Time", "Race Predictor"],
    isRecording: false
  }
];
...
export function EnhancedSmartwatchHub() {
    ...
    setTimeout(() => {
      setWatches(prev => prev.map(watch => 
        watch.connected ? {
          ...watch,
          lastSync: 'Just now',
          batteryLevel: Math.max(0, Math.min(100, watch.batteryLevel + Math.floor(Math.random() * 5) - 2)),
          heartRate: watch.heartRate ? 65 + Math.floor(Math.random() * 25) : undefined,
          steps: watch.steps ? watch.steps + Math.floor(Math.random() * 100) : undefined,
          calories: watch.calories ? watch.calories + Math.floor(Math.random() * 20) : undefined
        } : watch
      ));
  ...
  const getBrandColor = (brand: string) => {
    switch (brand.toLowerCase()) {
      case 'apple': return 'from-gray-500 to-gray-700';
      case 'samsung': return 'from-blue-500 to-blue-700';
      case 'garmin': return 'from-green-500 to-green-700';
  ...
  return (
    <Card className="w-full relative overflow-hidden">
      ...
      <CardContent>
        <Tabs value={selectedWatch} onValueChange={setSelectedWatch} className="w-full">
          <TabsList className="grid w-full grid-cols-3 mb-6">
            {watches.map((watch) => (
              ...
              >
                <div className="flex items-center gap-2">
                  <div className={`w-2 h-2 rounded-full ${watch.connected ? 'bg-green-400' : 'bg-red-400'}`} />
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="relative">
                    <div className={`w-20 h-20 bg-gradient-to-br ${getBrandColor(watch.brand)} rounded-2xl flex items-center justify-center shadow-lg`}>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-muted-foreground mb-3">{watch.model}</p>
                    ...
                    {watch.connected && (
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
                        <div className="flex items-center gap-2 p-2 bg-white/50 dark:bg-black/20 rounded-lg">
                          ...
                          <div>
                            <div className="font-semibold text-sm">{watch.heartRate}</div>
                        ...
                        <div className="flex items-center gap-2 p-2 bg-white/50 dark:bg-black/20 rounded-lg">
                          ...
                          <div>
                            <div className="font-semibold text-sm">{watch.steps?.toLocaleString()}</div>
                        ...
                        <div className="flex items-center gap-2 p-2 bg-white/50 dark:bg-black/20 rounded-lg">
                          ...
                          <div>
                            <div className="font-semibold text-sm">{watch.calories}</div>
                        ...
                        <div className="flex items-center gap-2 p-2 bg-white/50 dark:bg-black/20 rounded-lg">
                          ...
                          <div>
                            <div className="font-semibold text-sm">{watch.distance}km</div>
                    ...
                    <div className="flex items-center gap-4 text-sm">
                      <div className="flex items-center gap-2">
                        <Battery className={`h-4 w-4 ${getBatteryColor(watch.batteryLevel)}`} />
                        <span>{watch.batteryLevel}%</span>
                        <Progress value={watch.batteryLevel} className="h-2 w-16" />
                      </div>
