  ...
  useEffect(() => {
    ...
    const sampleNotifications: Notification[] = [
      ...
      },
      {
        ...
        message:
          "Time to drink water! You haven't logged water intake in 2 hours",
                            ...
                            {notification.data && (
                              <div className="mt-2 flex flex-wrap gap-2">
                                ...
                                {notification.type === "health" &&
                                  notification.data.heartRate >
                                    notification.data.maxSafe && (
                                    <Badge
                                      variant="destructive"
                                      className="text-xs"
                                    >
                                ...
                                {notification.type === "workout" &&
                                  notification.data.caloriesBurned && (
                                    <Badge
                                      variant="outline"
                                      className="text-xs"
                                    >
        ...
        {notifications.length > 4 && (
          <div className="mt-4 text-center">
            ...
            >
              {showAll
                ? "Show Less"
                : `Show All (${notifications.length - 4} more)`}
            </Button>
          </div>
        )}
